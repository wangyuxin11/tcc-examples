...
import org.tcc.examples.api.*;
import org.tcc.examples.core.common.MethodType;
...
public class CompensableMethodUtils {
    ...
    public static int getTransactionContextParamPosition(Class<?>[] parameterTypes) {
        ...
        for (int i = 0; i < parameterTypes.length; i++) {
            if (parameterTypes[i].equals(org.tcc.examples.api.TransactionContext.class)) {
                position = i;
                break;
            }
        }
    ...
    public static TransactionContext getTransactionContextFromArgs(Object[] args) {
        ...
        for (Object arg : args) {
            if (arg != null && org.tcc.examples.api.TransactionContext.class.isAssignableFrom(arg.getClass())) {

                transactionContext = (org.tcc.examples.api.TransactionContext) arg;
            }
        }
